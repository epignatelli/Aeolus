// AeolusPlugIn.cpp : defines the initialization routines for the plug-in.
//
...
RHINO_PLUG_IN_NAME(L"Aeolus");

// Rhino plug-in id
// Provide a unique uuid for this plug-in.
RHINO_PLUG_IN_ID(L"68E77481-AD81-4959-A9EB-5E596C0E4654");
...
RHINO_PLUG_IN_DESCRIPTION(L"Aeolus plug-in for Rhinoceros®");
...
// The one and only CAeolusPlugIn object
static class CAeolusPlugIn thePlugIn;

/////////////////////////////////////////////////////////////////////////////
// CAeolusPlugIn definition

CAeolusPlugIn& AeolusPlugIn()
{
	// Return a reference to the one and only CAeolusPlugIn object
	return thePlugIn;
}

CAeolusPlugIn::CAeolusPlugIn()
{
	// Description:
	//   CAeolusPlugIn constructor. The constructor is called when the
	//   plug-in is loaded and "thePlugIn" is constructed. Once the plug-in
	//   is loaded, CAeolusPlugIn::OnLoadPlugIn() is called. The
...
const wchar_t* CAeolusPlugIn::PlugInName() const
{
	// Description:
...
const wchar_t* CAeolusPlugIn::PlugInVersion() const
{
	// Description:
...
GUID CAeolusPlugIn::PlugInID() const
{
	// Description:
	...
	// {68E77481-AD81-4959-A9EB-5E596C0E4654}
...
BOOL CAeolusPlugIn::OnLoadPlugIn()
{
	// Description:
...
void CAeolusPlugIn::OnUnloadPlugIn()
{
	// Description:
